...
Repository in cui vengono salvati tutti i file necessari per il back-end e il front-end del sito web. Il sito viene utilizzato per eseguire in background una pipeline automatica di N8N hostata in locale.
